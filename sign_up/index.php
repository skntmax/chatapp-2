...
if(isset($_GET['email_alert'])){
	echo '<script>alert("Please sign up with different email : Email already exist")</script>';
}
...
if(isset($_GET['email_username_alert'])){
    echo "please sign up with different USERNAME and EMAIL";
  }
?>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/1.png');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="./user_validate/user_validation.php" method="post">
