...
<button type="button" class="btn btn-primary btn-lg button button1" data-toggle="modal" data-target="#modelId">
<img src="<?php echo $img_src;?>" alt="Avatar" class="left" id="update_dp"></div>
</button>
